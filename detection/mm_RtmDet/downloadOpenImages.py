...
src = os.path.expanduser("~/fiftyone")
dst = "mmdetection/data"
shutil.move(src, dst)

# Current paths
base = "mmdetection/data/fiftyone/open-images-v7"
target_base = "mmdetection/data/open-images-v7"
...
for sub in subdirs:
    ...
    dst = os.path.join(target_base, sub)
...
# Example usage
convert_to_voc("mmdetection/data/open-images-v7/train")
convert_to_voc("mmdetection/data/open-images-v7/validation")
...
flatten_and_clean_folder("mmdetection/data/open-images-v7/train")
flatten_and_clean_folder("mmdetection/data/open-images-v7/validation")
old_path = "mmdetection/data/open-images-v7/validation"
new_path = "mmdetection/data/open-images-v7/val"
